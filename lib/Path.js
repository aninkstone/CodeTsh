(function (){
    ...
    function win32Normalize(path, allowAboveRoot) {
        var res = '';
        var lastSlash = -1;
        var dots = 0;
        var code;
    ...
    const win32 = {
        ...
        resolve: function resolve() {
            ...
            resolvedTail = win32Normalize(resolvedTail, !resolvedAbsolute);
        ...
        normalize: function normalize(path) {
            ...
            var tail;
            if (rootEnd < len)
                tail = win32Normalize(path.slice(rootEnd), !isAbsolute);
            else
                tail = '';
    ...
    const posix = {
        ...
        resolve: function resolve() {
            ...
            // Normalize the path
            resolvedPath = posixNormalize(resolvedPath, !resolvedAbsolute);
